                ...
                <div id="order_summary" class="order-summary">
					...
					@if($c[0]==$p->intProductID)
                        <div  class="rTableRow" id="deleteItem_{{$c[3]}}">
							<div class="rTableCell"><img src="img/{{$p->image_name}}" height="50px" width="50px"> {{$p->txtProductName}}</div>
                            
                            <!--quantity-->
                                                                <!--c[1] is pid and c[3] is order serial-->
                            <div class="rTableCell">
                          <label id="quantity" style="width:25%" class="text-right" name={{$p->intProductID}}> {{$c[1]}} </label>
                            </div>			
                    ...
                    <div class="order-col">
                        ...
                        <div ><strong class="order-total" id="totalCost">Rp. {{number_format(Session::get('decPrice'),0,'.',',')}}</strong></div>
                    </div>
                    @else
                    <div class="order-col">
                ...
                <div class="payment-method">
                    <div class="input-radio">
                        ...
                        <div class="caption">
                            ...
                            <p>Setelah Transfer nominal di atas kemudian Tekan <img style="width:10%!important" src="{{asset('img/konfirmasi bayar.png')}}" alt=""></p>
                        </div>
                    </div>
                </div>
                @if(session('user'))
            ...
            <div class="col-md-7">
                ...
                <div class="billing-details">
                    ...
                    <div class="form-group">
                        ...
                        @foreach($prov as $pv)
                        <option value="{{$pv->id}}">{{$pv->nm_prov}}</option>
                        @endforeach
                        </select>
                    </div>
                    <div class="form-group">
