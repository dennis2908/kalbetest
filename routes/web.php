...
Route::post('/view/{id}', 'user\userController@post')->name('user.post_view');

Route::get('/cart', 'user\userController@cart')->name('user.cart');
Route::get('/confirm_payment', 'user\userController@confirm_payment')->name('user.confirm_payment');
Route::post('/confirm_payment', 'user\userController@confirm_payment_post')->name('user.confirm_payment_post');
