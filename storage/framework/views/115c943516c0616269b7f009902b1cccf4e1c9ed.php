        ...
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="product-details">
                    <h2 class="product-name"><?php echo e($product->txtProductName); ?></h2>
                    <div>
                    ...
                    <div>
                        <h3 class="product-price">Rp. <?php echo e(number_format($product->discount,0,'.',',')); ?>  <del class="product-old-price">Rp. <?php echo e(number_format($product->decPrice,0,'.',',')); ?> </del></h3>
                    ...
                    <div class="product-options" >
                        <input type="hidden" id="discount_price_holder" name="discount_price_holder" value=<?php echo e($product->discount); ?>>
                        <label>
                    ...
                    <ul class="product-links">
                        <li>Category:</li>
                        <li><a href="<?php echo e(route('user.search')); ?>?c=<?php echo e($product->category->id); ?>"><?php echo e($product->category->name); ?></a></li>
                    </ul>
                    <ul class="product-links">
                    <h4>Bagikan</h4>
...
<?php echo $__env->make('store.storeLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel-shopping\resources\views/store/product.blade.php ENDPATH**/ ?>